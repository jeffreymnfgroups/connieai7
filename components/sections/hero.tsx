    ...
    <SectionContainer id="hero" className="pb-12">
      <ViewContainer>
        <div
          ...
          {'CoNNIE AI - Meeting Intelligence Platform'}
        ...
        <h1 className="hero-headline font-bold text-center text-6xl max-lg:text-4xl max-md:text-3xl">
          ...
          What Matters Most in Your Meetings
        </h1>
        <p className="text-center text-neutral-500 mt-6">
          CoNNIE AI transforms every sales call, team meeting, and onboarding session
          <br />
          into actionable insights and automated follow-ups.
        </p>
