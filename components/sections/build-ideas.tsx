      ...
      <SectionContainer id="build-ideas" className="pb-8">
        <ViewContainer>
          <h2 className="leading-snug font-semibold text-4xl text-neutral-400 max-lg:text-3xl max-lg:text-center max-md:text-2xl">
            <span className="text-black">Transform your meetings</span> by
            leveraging AI-powered intelligence to efficiently{' '}
            <span className="text-black">
              Automate Post-Meeting Workflows
            </span>
            , revolutionizing the way you capture, analyze, and act on meeting insights.
          </h2>
        </ViewContainer>
      </SectionContainer>
