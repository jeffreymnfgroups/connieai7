      ...
      <ViewContainer className="footer-top-layer-container flex flex-row items-start justify-between max-lg:flex-col">
        ...
        <div className="company-cta-content-wrapper">
          <h2 className="leading-snug text-4xl font-semibold">
            CoNNIE AI - Meeting <br />
            Intelligence Platform
          </h2>
          <p className="text-neutral-500 text-sm mt-2">
            Transform your meetings into clear, actionable insights—so you <br />
            never miss a key moment again.
          </p>
          <div className="mt-4">
            <p className="text-neutral-500 text-sm">
              Contact us: <a href="mailto:support@getcoreai.com" className="underline hover:text-neutral-700">support@getcoreai.com</a>
            </p>
          </div>
